...
class DisplayPassedStudent extends StatefulWidget {
  const DisplayPassedStudent({super.key});

  @override
  State<DisplayPassedStudent> createState() => _DisplayStudentState();
}

class _DisplayStudentState extends State<DisplayPassedStudent> {
  List<Map> slist = [];
  Mydb mydb = new Mydb();
  ...
  void getData() {
    Future.delayed(Duration(milliseconds: 500), () async {
      ...
      slist = await mydb.db.rawQuery('select * from students where mark > 60');
      setState(() {});
    });
  }
